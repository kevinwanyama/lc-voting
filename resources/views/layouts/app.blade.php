            ...
            <main class="container mx-auto max-w-custom flex flex-col md:flex-row" >
                 ...
                 >
                     ...
                     <form action="#" method="POST" class="space-y-4  px-4 py-6">
                         <div>
                             <input type="text" class="w-full text-sm bg-gray-100 rounded-xl border-none placeholder-gray-900 px-4 py-2"
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl 
                            placeholder-gray-900 border-none text-sm px-4 py-2" placeholder="Describe your idea"></textarea>
                        </div>
