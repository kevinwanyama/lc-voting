<form wire:submit.prevent="createIdea" action="#" method="POST" class="space-y-4  px-4 py-6">
    ...
    <div>
       <select wire:model.defer="category" name="category_add" id="category_add" class= "w-full bg-gray-100 text-sm border-none rounded-xl px-4 py-2">
   ...
   <div>
       ...
       placeholder-gray-900 border-none text-sm px-4 py-2" 
