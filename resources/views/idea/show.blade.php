    ...
    <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
        ...
        <div class="w-full md:mx-4">
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <div class="relative">
                    <button
                        class="relative bg-gray-200 hover:bg-gray-400 border rounded-full h-7 transition duration-150 ease-in py-2 px-3"
                        @click="isOpen = !isOpen"
                    >
                    ...
                    >
                        <li><a href="#" class="hover:bg-gray-400 block transition duration-150 ease-in px-5 py-3">Mark as Spam</a></li>
                        <li><a href="#" class="hover:bg-gray-400 block transition duration-150 ease-in px-5 py-3">Delete Post</a></li>
                    </ul>
